...
const ContactSection = () => {
    ...
    return (
        <div className="portfolio-container" style={{ paddingBottom: '6rem' }}>
            <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
                <h2 className="gradient-text" style={{ fontSize: 'clamp(2.5rem, 8vw, 4.5rem)', marginBottom: '1rem' }}>Get In Touch</h2>
